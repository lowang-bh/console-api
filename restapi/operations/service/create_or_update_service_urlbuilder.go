...
func (o *CreateOrUpdateServiceURL) WithBasePath(bp string) *CreateOrUpdateServiceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateOrUpdateServiceURL) Build() (*url.URL, error) {
	...
	if appname != "" {
		...
		return nil, errors.New("Appname is required on CreateOrUpdateServiceURL")
	}
	...
	if groupname != "" {
		...
		return nil, errors.New("Groupname is required on CreateOrUpdateServiceURL")
	}
...
func (o *CreateOrUpdateServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateOrUpdateServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateOrUpdateServiceURL")
	}
