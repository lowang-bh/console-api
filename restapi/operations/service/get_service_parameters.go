...
func (o *GetServiceParams) bindAppname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetServiceParams) validateAppname(formats strfmt.Registry) error {
...
func (o *GetServiceParams) bindGroupname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServiceParams) validateGroupname(formats strfmt.Registry) error {
