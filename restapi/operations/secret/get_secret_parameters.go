...
func (o *GetSecretParams) bindAppname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSecretParams) validateAppname(formats strfmt.Registry) error {
...
func (o *GetSecretParams) bindGroupname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSecretParams) validateGroupname(formats strfmt.Registry) error {
