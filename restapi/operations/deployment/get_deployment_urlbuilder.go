...
func (o *GetDeploymentURL) Build() (*url.URL, error) {
	...
	var _path = "/groups/{group}/apps/{app}/deployment"

	app := swag.FormatInt64(o.App)
	if app != "" {
		_path = strings.Replace(_path, "{app}", app, -1)
	} else {
		return nil, errors.New("App is required on GetDeploymentURL")
	}
	...
	if group != "" {
		...
		return nil, errors.New("Group is required on GetDeploymentURL")
	}
