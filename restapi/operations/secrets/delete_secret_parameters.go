...
func (o *DeleteSecretParams) bindGroupname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteSecretParams) validateGroupname(formats strfmt.Registry) error {
