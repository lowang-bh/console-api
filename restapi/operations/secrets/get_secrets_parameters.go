...
func (o *GetSecretsParams) bindGroupname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSecretsParams) validateGroupname(formats strfmt.Registry) error {
