...
func (o *GetAppURL) Build() (*url.URL, error) {
	...
	if app != "" {
		...
		return nil, errors.New("App is required on GetAppURL")
	}
	...
	if group != "" {
		...
		return nil, errors.New("Group is required on GetAppURL")
	}
...
func (o *GetAppURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAppURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAppURL")
	}
